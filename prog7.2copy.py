...
def show_image():
    ...
    if image_url:
        try:
            ...
            # new_window.title("Случайнок изображение")
...
window = Tk()
window.title("Изображение собачек")
window.geometry("360x420")

label = ttk.Label()
label.pack(pady=10)

button = ttk.Button(text="Загрузить изображение", command=prog_bar)
button.pack(pady=10)
...
hight_label.pack(side='left', padx=(10, 0))
hight_spinbox = ttk.Spinbox(from_=200, to=500, increment=50, width=5)
hight_spinbox.pack(side='left', padx=(0, 10))
